...
export const testimonials: Testimonial[] = [
  {
    quote: "Able to translate scientific publications into blog post that are engaging and fun to read. People with no background in research will understand the subject matter when reading Emma's blogs.",
    author: {
  ...
  {
    quote: "They helped out both strategically and in a hands-on capacity.",
    author: {
      title: "Founder",
  ...
  {
    quote: "They're everything I was looking for. They quickly developed a keen sense of what's important in our unique format, tackled the tasks expertly and gracefully and responded well to feedback.",
    author: {
      title: "Founder",
